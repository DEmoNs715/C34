...
function setup() 
{
  ...
  star = createSprite (270,75);
  star.addImage (star_png);
  star.scale = 0.02

  estrella = createSprite (125,300)
  estrella.addImage (star_png);
  estrella.scale = 0.02;

  stars = createSprite (50,56);
  stars.addAnimation ("empty",empty_star);
  stars.addAnimation ("one",one_star);
  stars.addAnimation  ("two",two_star);
  stars.scale = 0.2;
...
if (collide(fruit,estrella,20)===true){
